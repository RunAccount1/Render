return (function(ria) 
	...
	table.insert(taskfunctions, {
		...
		Function = function()
			return --local requested, userdata = pcall(function() return httpService:JSONDecode(httprequest({Url = 'https://api.renderintents.xyz/ria', Headers = {RIA = ria}}).Body) end)
		end
	})
